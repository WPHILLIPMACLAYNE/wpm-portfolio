        ...
        >
          ...
          <div className="space-y-4 mb-10">
            {profile.bio.map((p, i) => (
              <motion.p
                key={i}
                className="text-wpm-gray/60 leading-relaxed break-words"
          ...
          {profile.skillGroups && (
            <div className="space-y-6 mb-10">
              <p className="font-mono text-[10px] text-wpm-purple/50 mb-1 uppercase tracking-wider">
                Character Stats
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {profile.skillGroups.map((group, gi) => (
                  ...
                  >
                    <p className="font-mono text-[10px] text-wpm-purple/50 mb-3 uppercase tracking-wider">
                      {group.name}
                    </p>
